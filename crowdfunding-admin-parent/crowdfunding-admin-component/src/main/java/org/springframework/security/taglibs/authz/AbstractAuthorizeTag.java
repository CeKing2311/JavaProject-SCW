...
public abstract class AbstractAuthorizeTag {
	...
	/**
	 * This method allows subclasses to provide a way to access the
	 * ServletRequest according to the rendering technology.
	 */
	protected abstract ServletRequest getRequest();

	/**
	 * This method allows subclasses to provide a way to access the
	 * ServletResponse according to the rendering technology.
	 */
	protected abstract ServletResponse getResponse();

	/**
	 * This method allows subclasses to provide a way to access the
	 * ServletContext according to the rendering technology.
	 */
	 ...
	 * "Expression-Based Access Control" chapter in Spring Security for details
	 * on what expressions can be used.
	 *
	 * @return the result of the authorization decision
	 * @throws IOException
	 */
	...
	/**
	 * Make an authorization decision based on the URL and HTTP method
	 * attributes. True is returned if the user is allowed to access the given
	 * URL as defined.
	 *
	 * @return the result of the authorization decision
	 * @throws IOException
